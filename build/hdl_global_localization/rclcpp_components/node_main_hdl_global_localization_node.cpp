...
#define NODE_MAIN_LOGGER_NAME "hdl_global_localization_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libhdl_global_localization_lib.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<hdl_global_localization::GlobalLocalizationNode>";
