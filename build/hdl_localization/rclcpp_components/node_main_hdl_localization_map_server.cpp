...
#define NODE_MAIN_LOGGER_NAME "hdl_localization_map_server"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libhdl_localization_lib.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<hdl_localization::GlobalmapServerNodelet>";
